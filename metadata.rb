...
attribute 'remi/main/priority',            :default => '1'
attribute 'remi/php55/enabled',            :default => '0'
attribute 'remi/php55/priority',           :default => '1'
attribute 'remi/test/enabled',             :default => '0'
attribute 'remi/test/priority',            :default => '1'
attribute 'remi/debuginfo/enabled',        :default => '0'
attribute 'remi/debuginfo/priority',       :default => '1'
attribute 'remi/php55_debuginfo/enabled',  :default => '0'
attribute 'remi/php55_debuginfo/priority', :default => '1'
attribute 'remi/test_debuginfo/enabled',   :default => '0'
attribute 'remi/test_debuginfo/priority',  :default => '1'
